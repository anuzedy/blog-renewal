...
export default function AdjacentPostCard({ post: { id, thumbnail, title, description }, type }: Props) {
  return <Link href={`/post/${id}`} className="relative w-full bg-black max-h-56">
    <Image
